package io.github.oguzhancevik.technicalservice.controller.base;
...
import io.github.oguzhancevik.technicalservice.controller.SessionObject;
import io.github.oguzhancevik.technicalservice.controller.TypeBean;
...
public abstract class BaseBean<T extends ExtendedModel> implements Serializable {
	...
	/**
	 * @see io.github.oguzhancevik.technicalservice.dao.base.BaseDao#save(ExtendedModel)
	 ...
	 * metoddur.
	 * 
	 * @see io.github.oguzhancevik.technicalservice.dao.base.BaseDao#passive(ExtendedModel)
	 * @see #init()
	 * @param removeModel
